...
<div class="page-content">
				<div class="card border-top border-0 border-4 border-danger">
					<div class="card-body p-5">
						...
						<div class="row g-3" style=" cursor: pointer;background: #e0efff; padding: 0px 20px 20px 20px; border-radius: 8px; margin-bottom:30px; margin-top:20px;">
							<div class="col-md-12">
								<div class="row">
									...
									<div class="col py-2">
										<div class="card-body" style="padding-top:0px;">
											<div class="row">
												...
												<a target="_blank" href="{{asset('image/'.$Sample->collect_lab_sample_meter_photo)}}" class="col-md-4 geeks">
									...
									<div class="col py-2">
										<div class="card-body" style="padding-top:0px;">
											<div class="row">
												...
												<a target="_blank" href="{{asset('image/'.$Sample->submit_hospital_sample_meter_photo)}}" class="col-md-4 geeks">
