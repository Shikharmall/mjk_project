@extends('Admin.app')
@section('title',('All Collection Detail'))
...
<div class="page-wrapper">
			<div class="page-content">
				<h6 class="mb-0 text-uppercase">All Collection Detail</h6>
				<hr/>
				<div class="card border-top border-0 border-4 border-danger">
                    ...
                    <tr>
                      ...
                      <a class="row g-3" href="{{route('panel.AllReport.collection-sample',[$data->hospital_id])}}" style=" cursor: pointer;background: #e0efff; padding: 0px 10px 20px 10px; border-radius: 8px;">
