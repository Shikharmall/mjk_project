@extends('Admin.app')
@section('title',('All Submitted Report'))
...
<div class="page-wrapper">
			<div class="page-content">
				<h6 class="mb-0 text-uppercase">All Submitted Report</h6>
				<hr/>
				<div class="card border-top border-0 border-4 border-danger">
                    ...
                    <tr>
                      <td style="padding: 28px 11px 0px;">
                        ...
                        <a class="row g-3" href="{{route('panel.AllReport.submitted-report-sample',[$data->hospital_id])}}" style=" cursor: pointer;background: #e0efff; padding: 0px 10px 20px 10px; border-radius: 8px;">
