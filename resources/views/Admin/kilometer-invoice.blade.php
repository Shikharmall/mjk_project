@extends('Admin.app')
@section('title',('Kilometer Invoice'))
...
function kreset()
{
    window.location.href = "{{url('panel/Invoice/kreset')}}";
}
</script>
	...
	<div class="page-content">
		<div class="card border-top border-0 border-4 border-danger">
			<div class="card-body p-5">
                <h6 class="mb-0 text-uppercase">Kilometer Invoice <label style="float:right;color:#fd3550!important;"> Per Kilometer Rate Rs. {{$rate}}</label></h6>
				<hr/>
			
            <div class="row g-3" style="margin-top:15px;">
            <div class="col-md-7" style="background:white; padding:10px;">
                <form class="row g-3" action="{{route('panel.Invoice.kfilter')}}" method="POST" enctype="multipart/form-data">
                @csrf
