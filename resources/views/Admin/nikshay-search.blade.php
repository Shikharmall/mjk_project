...
<div class="page-wrapper">
			<div class="page-content">
				<h6 class="mb-0 text-uppercase" style="padding-bottom: 10px;">Nikshay Search <button class="btn btn-success" style="float: right;padding: 10px 20px;font-size: 14px; margin-right:5px;" id="btnExport" onclick="fnExcelReport3();">Export</button></h6>
				<hr/>
					...
					<tbody>              
                         @foreach($sample as $sample)
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="action">
                                      <a href="{{route('panel.Invoice.sample-submitted-info',[$sample->id])}}" target="_blank" class="btn btn-info" style="font-size:13px; color:white;" title="View">
                                      View
                                      </a>
                                    </div>
                                  </td>            
