@extends('Admin.app')
@section('title',('Sample Invoice Detail'))
	...
	<div class="page-content">
		<div class="card border-top border-0 border-4 border-danger">
			<div class="card-body p-5">
                <h6 class="mb-0 text-uppercase" style="padding-bottom:10px;">Sample Invoice Detail<button class="btn btn-success" style="float: right;padding: 10px 20px;font-size: 14px; margin-right:5px;" id="btnExport" onclick="fnExcelReport3();">Export</button></h6>
				<hr/>
